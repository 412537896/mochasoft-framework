...
/**
 * <strong>Title : PropertiesLoader </strong>. <br>
 * <strong>Description : Properties文件载入工具类.</strong> <br>
 * 可载入多个properties文件, 相同的属性在最后载入的文件中的值将会覆盖之前的值，但以System的Property优先<br>
 * <strong>Create on : 2013-1-5 下午1:23:30 </strong>. <br>
 * <p>
	...
	private Properties loadProperties(String... resourcesPaths) {
		...
		for (String location : resourcesPaths) {
			if (logger.isDebugEnabled()) {
				logger.debug("loadProperties(String) - String location={}", location); //$NON-NLS-1$
			}
