package com.mochasoft.fk.security.common;
...
public class SpringSecurityUtils {
	/**
	 * 取得当前用户, 返回值为IUserDetails子类, 如果当前用户未登录则返回null.
	 */
	@SuppressWarnings("unchecked")
	public static <T extends IUserDetails> T getCurrentUser() {
	...
	public static boolean hasAnyRole(String... roles) {
		IUserDetails userDetails = getCurrentUser();
		if (userDetails == null) {
			return false;
		}
